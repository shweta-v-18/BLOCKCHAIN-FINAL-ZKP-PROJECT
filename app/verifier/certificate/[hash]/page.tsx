  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        ...
        text: `Verify certificate for ${certificate?.studentName} from ${certificate?.university}`,
          ...
          <Card className="max-w-3xl mx-auto bg-black border-gray-800">
            <CardContent className="pt-6">
              <Alert variant="destructive" className="bg-red-900 border-red-800 text-red-200">
                <AlertTitle>Certificate Verification Failed</AlertTitle>
          ...
          <CardContent className="pt-6">
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-gray-400">Certificate Verification</p>
              </div>
              <Badge className="bg-green-600 text-white px-3 py-1 text-sm flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="flex flex-col items-center justify-center space-y-6">
                ...
                <div className="text-center">
                  ...
                  <p className="font-mono text-xs break-all bg-gray-800 p-2 rounded">{certificate.id}</p>
                </div>
